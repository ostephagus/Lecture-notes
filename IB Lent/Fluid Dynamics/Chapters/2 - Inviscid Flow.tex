...
\begin{examples}{
    ...
    \item Line vortex: consider cylindrical polar coordinates, $\vec{u} = \frac{\kappa}{2\pi r} \vec{e_\phi}$. Then we find that $\vec{w} = \kappa \delta(r) \vec{e_z}$.
\end{examples}
\end{document}