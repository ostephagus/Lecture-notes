...
\begin{proof}
    ...
    \begin{align*}
        ...
        &= \left(\int_{\overline{C} \cap C^\star} f_1(\vec{x}) d^n \vec{x} + \int_{\overline{C} \cap \overline{C^\star}} f_1(\vec{x}) d^n\vec{x}\right) \\
        &\qquad - \left(\int_{\overline{C^\star}\cap C} f_1(\vec{x}) d^n \vec{x} \int_{\overline{C^\star} \cap \overline{C}}f_1(\vec{x}) d^n\vec{x}\right)\\
...
\begin{example}
    ...
    \begin{align*}
        ...
        &= 2\underbrace{\sum_{i=1}^{n} \delta_i}_{0} + \sum_{i=1}^{n} \frac{\delta_i^2}{e_i} + O(\delta_i^3) \\
        &\approx \sum_{i=1}^{n} \frac{(o_i - e_i)^2}{e_i}
    \end{align*}
    ...
    \end{equation*}
    and $\chi_3^2(0.95) \approx 7.815 > 0.604$. Therefore we do not reject $H_0$. The $p$-value is:
    \begin{equation*}
        \P(Y \sim \chi_3^2 \geq 0.604) \approx 0.96
    \end{equation*}
\end{example}
...
\begin{example}
    ...
    \begin{align*}
        ...
        &= 2\sum_{i=1}^{3} o_i \log\left(\frac{o_i}{e_i}\right) \\
        &\approx \sum_{i=1}^{3} \frac{(o_i - e_i)^2}{e_i}
    \end{align*}
...
Suppose $(X_1, Y_1), \cdots, (X_n, Y_n)$ are independent and identically distributed with $X_i$ taking values in $\{1, \cdots, r\}$ and $Y_i$ taking values in $\{1, \cdots, c\}$. We wish to test the null hypothesis that $X_i$ and $Y_i$ are independent. The entries in a \underline{contingency table} are:
\begin{equation*}
...
\begin{example}
    ...
    \begin{align*}
        ...
        &\approx \sum_{i=1}^{r} \sum_{j=1}^{c} \frac{(o_{ij} - e_{ij})^2}{e_{ij}}
    \end{align*}
...
\begin{proof}
    ...
    \begin{align*}
        ...
        \end{pmatrix}
    \end{align*}
    where $\tilde{A}$ is the matrix chosen such that $A$ is orthogonal.
