...
Then the Von-Neumann-Morgensten Theorem, says that, under certain assumptions, the best choice of $\delta$ is the minimiser of the expected loss under the posterior distribution.
\end{document}