...
\begin{proof}
    \begin{enumerate}
        ...
        \item Fix $i \in I$. now:
            \begin{align*}
                \nu_k(i) &= \E_k\left(\sum_{n=1}^{T_k} \ind{X_n = i}\right) \\
                &= \E_k\left(\sum_{n=1}^{\infty}\ind{X_n = i} \ind{n \leq T_k}\right) \\
                &= \sum_{n=1}^{\infty} \P(X_n = i, T_k \geq n) \\
                &= \sum_{n=1}^{\infty} \sum_{j \in I} \P_k(X_n = i, X_{n-1} = j, T_k \geq n) \\
                &= \sum_{n=1}^{\infty} \sum_{j \in I} \P_k(X_n = i | X_{n-1} = j, T_k \geq n) \P_k(X_{n-1} = j, T_k \geq n) \\
            \end{align*}
...
\begin{proof}
    ...
    \begin{align*}
        ...
        \intertext{and because $\lambda_{j_n} \geq 0$,}
        &\geq P(k, i) + \sum_{j_1 \neq k}P(k, j_1) P(j_1, i) + \cdots \\
        &+ \sum_{j_1, \cdots, j_{n-1} \neq k} P(k, j_{n-1}) P(j_{n-1} j_{n-2}) \cdots P(j_1, i)
    \end{align*}
    Now take $i \neq k$.
...
\begin{proof}
    ...
    \begin{subproof}{Statement 2 implies statement 3}
        ...
        \end{equation*}
    \end{subproof}
    \begin{subproof}{Statement 3 implies statement 1}
...
\begin{proof}
    ...
    \begin{subproof}{$Y$ is a Markov chain with transition matrix $\hat{P}$.}
        ...
        \end{align*}
    \end{subproof}
    The irreducibility of $\hat{P}$ follows from the fact that:
    \begin{equation*}
