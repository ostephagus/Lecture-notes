...
\begin{definition}{Definiteness}
    ...
    \begin{enumerate}
        \item $\varphi$ is \underline{positive-definite} if $\varphi(v, v) > 0$ for all $v \in V$.
        \item $\varphi$ is \underline{positive semi-definite} if $\varphi(v, v) \geq 0$ for all $v \in V$.
        \item $\varphi$ is \underline{negative definite} if $\varphi(v, v) < 0$ for all $v \in V$.
        \item $\varphi$ is \underline{negative semi-definite} if $\varphi(v, v) \leq 0$ for all $v \in V$.
