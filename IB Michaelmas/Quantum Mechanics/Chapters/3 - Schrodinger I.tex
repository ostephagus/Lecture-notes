...
\end{proposition}
\begin{proof}
    Suppose that such a series does not terminate, and we look at the asymtotic behaviour. For $n \to \infty$, use equation~\ref{eqnQHMRecurRelation}:
    \begin{equation*}
